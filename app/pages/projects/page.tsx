    ...
    return (
        <section className="h-screen pl-[10%] pt-40">
            <div className="animate-fade-in">
                ...
                <h3 className="pt-2 font-heading2">Click on a project name below to visit the site</h3>
                    <div id="project1" className="pt-12">
                        <Link href="https://mtgbrowser.com" target="_blank" rel="noopener noreferrer" className="font-heading text-2xl hover:text-sky-300! transition-colors">MTG Browser</Link>
                        <h3 className="font-heading2 text-sky-300!">TypeScript, React, Next.js</h3>
                    ...
                    <div id="project2" className="pt-15">
                        <Link href="https://laravel-fantasy-basketball.onrender.com" target="_blank" rel="noopener noreferrer" className="font-heading text-2xl hover:text-sky-300! transition-colors">NBA Stats Viewer</Link>
                        <h3 className="font-heading2 text-sky-300!">PHP, Laravel</h3>
