                ...
                <h1 className="font-heading text-4xl">About Me</h1>
                    <div className="flex">
                        <p className="font-body pt-5 w-[50%]">
                            ...
                            I am passionate about contributing to meaningful work, and I am excited to make a positive impact on a team.
                        </p>
                        <div className="pl-40">
                    ...
                    <div className="gap-10">
                        <h3 className="text-sky-300 text-xl pl-30 pt-15">Some of The Technologies I&apos;m Experienced with</h3>
