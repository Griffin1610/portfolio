                ...
                <h1 className="font-heading text-4xl">About Me</h1>
                    <div className="flex">
                        <p className="font-body pt-5 w-[50%]">
                            ...
                            <br></br>
                            <br></br>
                            I have professional experience building full stack web applications using TypeScript, JavaScript, React, and Next.js through an Agile and Git enviroment. I also have additional experience building Python and .NET appliactions. 
