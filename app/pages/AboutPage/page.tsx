            ...
            <h1 className="font-heading text-4xl">About Me</h1>
                <div className="flex">
                    <p className="font-body pt-5 w-[50%]">
                        I am an entry-level software developer, who graduated from the University of Wisconsin-Whitewater in December of 2025. 
                        I have practical experience building web applications using TypeScript, JavaScript, React, and Next.js, with additional experience building Python and .NET appliactions. 
