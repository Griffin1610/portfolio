    ...
    return (
        <section className="h-screen pl-[10%] pt-40 w-[70%]">
                <div className="animate-fade-in">
                    ...
                    <div id="internship">
                        <h3 className="text-xl font-heading pt-10">Software Development Intern</h3>
                        <h3 className="font-body text-sky-300!">Blain Supply | Janesville, Wi | June 2025 - Aug 2025</h3>
                    ...
                    <div id="research">
                        <h3 className="text-xl font-heading pt-10">Undergraduate Research</h3>
                        <h3 className="font-body text-sky-300!">UW-Whitewater | Whitewater, Wi | Sept 2024 - December 2025</h3>
                            <ul className="list-disc pl-5">
                    ...
                    <div id="certification">
                        <h3 className="text-xl font-heading pt-10">Certification</h3>
                        <h3 className="font-body text-sky-300!">Google Professional Machine Learning Engineer | Issued: February 2025</h3>
                        <ul className="list-disc pl-5">
                        <li className="font-body pt-2 ml-3">Validates expertise in Google Cloud services including Vertex
                            ...
                            <li className="font-body pt-2 ml-3">View the certification here:
                                <Link className="underline text-heading1 hover:text-blue-300 pl-2" href="https://www.credly.com/badges/2bcc8327-5b3a-418c-9e05-1156b1be03e7/public_url">Google PMLE Certification</Link>
                            </li>
                        </ul>
                    </div>
                </div>
