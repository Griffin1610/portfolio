...
export default function Resume() {
    return (
        <section className="h-screen pl-[10%] pt-40">
            ...
            <h3 className="font-heading2 text-large pt-2">Please click below to view my Resume</h3>
            ...
            <h3 className="font-heading2 text-large pt-15">Thank you for visting my portfolio!</h3>
        </section>
    )
}